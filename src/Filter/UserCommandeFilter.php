...
class UserCommandeFilter extends AbstractFilter
{
    private array $relations;

    public function __construct(ManagerRegistry $managerRegistry, array $relations = ['UserCommande'])
    {
    ...
    protected function filterProperty(
        ...
        $queryBuilder
            ...
            ->andWhere(sprintf('%s.id = :userId', $relatedAlias)) // Correction ici
    ...
    public function getDescription(string $resourceClass): array
    {
        return [
            'UserCommande' => [
                ...
                'required' => false,
                'description' => 'Filter by User ID in UserCommande',
            ],
        ];
    }
